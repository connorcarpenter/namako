...
macro_rules! step_attribute {
    ($name:ident) => {
        ...
        /// # Function arguments
        ///
        /// - First argument has to be a context wrapper type. The `StepContext`
        ///   impl is auto-generated by `#[derive(World)]`.
...
/// - `#[param(regex = "regex")]`
///
///   Regular expression to match this parameter. Usually shouldn't contain any capturing
