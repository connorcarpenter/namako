...
/// [Namako]: https://cucumber.io
#[derive(Debug)]
pub enum Namako<World> {
    /// [`Namako`] execution being started.
    Started,
...
impl<World> Namako<World> {
    ...
    /// Constructs a [`Namako`] event from the given [`Scenario`] event.
    #[must_use]
    pub fn scenario(
        feat: impl Into<Source<gherkin::Feature>>,
...
pub enum Feature<World> {
    ...
    /// [`Scenario`] event.
    Scenario(Source<gherkin::Scenario>, Scenario<World>),
