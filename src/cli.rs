...
//! [`Runner`]: crate::Runner
//! [`Writer`]: crate::Writer
//! [1]: https://cucumber.io/docs/namako/api#tag-expressions
...
/// Root CLI (command line interface) of a top-level [`Namako`] executor.
///
...
///         &mut self,
///         ev: parser::Result<Event<event::Namako<W>>>,
///         cli: &Self::Cli,
///     ) {
